...
##### Each variable does not have its own column and each observation does not have its own row. The incomes themselves should not be the variables.
...
##### Each day should not be its own column.
