...
homerange %>% 
  ...
  geom_histogram(alpha = 0.6, color = "black", fill = "sienna", bins=40)+
...
homerange %>% 
  ggplot(aes(x = log10.hra)) +
  geom_density(alpha = 0.6, color = "black", fill = "sienna")+
  labs(title = "Distribution of Homerange")
```
...
homerange %>% 
  ggplot(aes(x = log10.hra)) +
  geom_histogram(aes(y = ..density..), binwidth = .4, fill = "lavender", alpha = 0.9, color = "black")+
